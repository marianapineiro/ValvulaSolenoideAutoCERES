...
%28/10/2021 - Mariana Obiedo Piñeiro
%--------------------------------------
close all;
clear all;
...
figure;
plot(tempo,M,'Color',[0.8500 0.3250 0.0980]);
grid;
title ('Vazão volumétrica') ;
legend('Q')
xlabel('t [s]');
ylabel('Q [L/s]');